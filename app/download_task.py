...
class DownloadTask(QObject):
    ...
    def __init__(self, url):
        ...
        self.duration = None
        # Границы обрезки в секундах; None — «от начала» и «до конца»,
        # так что от нуля их надо отличать.
        self.clip_start = None
        self.clip_end = None
        # Форматы храним сокращённо: полный ответ yt-dlp — десятки килобайт
        # на видео, а в очереди их бывают сотни.
        self.formats = []
    ...
    def _compact_formats(formats):
        """Оставляет от списка форматов только показываемые поля.

        Дорожки без картинки отбрасываем — звук отдельно есть в пункте
        «только звук».
        """
        compact = []
